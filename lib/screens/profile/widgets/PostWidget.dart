      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Image.asset(AppIcons.three_dot,width: 15,),
                          SizedBox(height: 8,),
                          Row(
                            children: [
                      ...
                      text: TextSpan(
                        ...
                        children: [
                          TextSpan(
                            ...
                            style:
                                GoogleFonts.publicSans(fontSize: 7),
                          ),
                        ],
                      ),
                    ),
            ...
            widget.isSinglePost 
                ?!widget.postModel.interactions!
                        .contains('comments')? CommentWidget(
                    ...
                    isSinglePost: widget.isSinglePost,
                      ...
                      style:
                          GoogleFonts.publicSans(color: AppColors.black, fontSize: 11),
                    )
                : InkWell(
                    onTap: () {
                      showComments(
                    ...
                    child: Text(
                      ...
                      style:
                          GoogleFonts.inter(color: Colors.grey, fontSize: 8),
                    ),
                  ),
